        ...
        <div className="container mx-auto px-6">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex-shrink-0 flex items-center cursor-pointer" onClick={() => navigate('/')}>
              <span className="text-estate-primary text-xl font-bold">EstateSearch</span>
            </div>
              ...
              <div className="ml-10 flex items-center space-x-8">
                {['Home', 'Search', 'Features', 'Pricing'].map((item, index) => (
                  <span
                    ...
                    className="cursor-pointer text-gray-600 hover:text-estate-primary transition-colors"
                  >
                    {item}
                  </span>
                ))}
            ...
            <div className="hidden md:block">
              <div className="flex items-center space-x-4">
                ...
                <Button 
                  ...
                  className="bg-estate-primary hover:bg-estate-dark text-white"
                >
                  Sign up
                </Button>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
              <div className="animate-fade-in">
                ...
                <Button 
                  ...
                  className="bg-white text-estate-primary hover:bg-opacity-90"
                >
                  Get Started
                </Button>
              </div>
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {features.map((feature, index) => (
                ...
                >
                  <div className="text-estate-primary mb-4 flex justify-center">
                    {feature.icon}
                  </div>
          ...
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {stats.map((stat, index) => (
                ...
                >
                  <div className="text-estate-primary mb-3">
                    {stat.icon}
                  </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <a href="#" className="text-gray-500 hover:text-estate-primary">
